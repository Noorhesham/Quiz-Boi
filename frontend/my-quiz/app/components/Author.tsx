  ...
  return (
    <HoverCard>
      <HoverCardTrigger asChild>
        <div className="flex self-end lg:flex-nowrap flex-wrap mt-auto relative items-center justify-between w-full md:gap-2">
          <User author={author} />
          {quiz && (
      ...
      {hover && mounted && createPortal(<UserInfro author={author} />, global?.document?.body)}
    </HoverCard>
  );
};
