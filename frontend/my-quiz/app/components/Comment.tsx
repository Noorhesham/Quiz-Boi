...
const Comment = ({ comment }: { comment: any }) => {
  ...
  return (
    <div className="flex  items-center bg-gray-50  p-1 rounded-md w-full gap-2">
      <div className="flex flex-wrap text-left items-center gap-2">
        <User author={comment.user} />
        <p className=" border-l-2  ml-auto  pl-1 border-gray-300 text-gray-700 text-sm md:text-base">{comment.content}</p>
      </div>
