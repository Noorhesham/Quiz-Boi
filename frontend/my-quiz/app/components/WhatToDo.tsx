...
const WhatToDo = ({ text, logged ,img}: { text: string; logged: boolean,img:string }) => {
  return (
<div className={`glass glass flex gap-2 flex-col py-4 px-8 rounded-lg shadow-md`}>
      ...
      />:<Button className=" text-gray-800 text-sm md:text-xl hover:bg-gray-200 bg-white rounded-xl self-start">
